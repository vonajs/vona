const procedure_base = require('./local.procedure/local.procedure_base.js');
const procedure_atom_selectAtoms = require('./local.procedure/local.procedure_atom_selectAtoms.js');
const procedure_atom_selectAtoms_0 = require('./local.procedure/local.procedure_atom_selectAtoms_0.js');
const procedure_atom_selectAtoms_draft = require('./local.procedure/local.procedure_atom_selectAtoms_draft.js');
const procedure_atom_selectAtoms_formal = require('./local.procedure/local.procedure_atom_selectAtoms_formal.js');
...
const procedure_utils_fieldsRight = require('./local.procedure/local.procedure_utils_fieldsRight.js');
...
module.exports = module.meta.util.mixinClasses(procedure_base, [
  procedure_atom_selectAtoms,
  procedure_atom_selectAtoms_0,
  procedure_atom_selectAtoms_draft,
  procedure_atom_selectAtoms_formal,
