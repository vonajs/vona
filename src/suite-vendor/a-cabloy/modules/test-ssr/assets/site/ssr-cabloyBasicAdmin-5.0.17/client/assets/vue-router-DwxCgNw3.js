import { o as defineComponent, k as inject, c as computed, F as unref, p as provide, l as ref, d as watch, M as h, O as shallowRef, r as reactive, s as shallowReactive, y as nextTick } from "./vue-CRNsYCTs.js";
...
function createRouterMatcher(routes, globalOptions) {
  ...
  function resolve(location2, currentLocation) {
    ...
    if ("name" in location2 && location2.name) {
      ...
      if (!matcher)
        return resolve({ path: "/404" }, currentLocation);
      if (!matcher)
  ...
  setup(props, { slots }) {
    ...
    return () => {
      ...
      return props.custom ? children : h("a", {
        ...
        href: link.href === "/404" ? props.to?.name : link.href,
...
function createRouter(options) {
  ...
  async function pushWithRedirect(to, redirectedFrom) {
    ...
    return (failure ? Promise.resolve(failure) : navigate(toLocation, from)).catch((error) => isNavigationFailure(error) ? (
      ...
      triggerAfterEach(toLocation, from, failure2, info);
      return failure2;
    });
  }
...
export {
  ...
  createRouter as b,
  createWebHistory as c,
  RouterLink as d,
  routerViewLocationKey as r
};
