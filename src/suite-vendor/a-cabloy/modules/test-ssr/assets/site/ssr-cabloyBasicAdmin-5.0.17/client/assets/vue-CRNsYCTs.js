...
function unrefNested(ref2) {
  return isRef(ref2) ? unrefNested(ref2.value) : ref2;
}
...
export {
  Transition as $,
  onUnmounted as A,
  queuePostFlushCb as B,
  useSlots as C,
  isRef as D,
  EMPTY_OBJ as E,
  unref as F,
  hasInjectionContext as G,
  onScopeDispose as H,
  shallowReadonly as I,
  readonly as J,
  toRefs as K,
  toRaw as L,
  h as M,
  ...
  normalizeStyle as X,
  isBooleanAttr as Y,
  includeBooleanAttr as Z,
  KeepAlive as _,
  watchPostEffect as a,
  withDirectives as a0,
  vModelText as a1,
  openBlock as a2,
  createElementBlock as a3,
  createBaseVNode as a4,
