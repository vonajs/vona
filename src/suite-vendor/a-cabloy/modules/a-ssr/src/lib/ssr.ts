...
>(
  ...
  return Aspect.interceptor('a-ssr:ssrRedirect', Object.assign(
    {},
    options,
    { site: site as any, pagePath: pagePath as any, pageOptions: pageOptions as any },
  ));
}
...
>(
  ...
  return Aspect.interceptor('a-ssr:ssrRender', Object.assign(
    {},
    options,
    { site: site as any, pagePath: pagePath as any, pageOptions: pageOptions as any },
  ));
