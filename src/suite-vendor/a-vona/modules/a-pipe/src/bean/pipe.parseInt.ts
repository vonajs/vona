...
export class PipeParseInt extends BeanBase<ScopeModule> implements IPipeTransform<any, number | undefined | null> {
  async transform(value: any, metadata: RouteHandlerArgumentMeta, options: IPipeOptionsParseInt) {
