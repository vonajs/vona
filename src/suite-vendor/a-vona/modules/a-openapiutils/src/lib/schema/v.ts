...
import { schemaCaptcha, schemaCurrency, schemaCustomKey, schemaDate, schemaOrder, schemaRender, schemaRest, schemaSelect, schemaToggle, schemaVisible } from './v/rest.ts';
