...
@Dto<IDtoOptionsTestResult>({
  fields: {
    ...
    }), v.default('custom'), v.optional(), v.min(6), z.string()),
    _custom2: $makeSchema(v.openapi({
      rest: {
        form: {
          render: (
            <div className="text-center">
              ...
              <ZZIcon name={$iconName('::home')} nativeOnClick={<action><ActionLog message="sss"></ActionLog></action>}></ZZIcon>
            </div>
          ),
        },
        label: 'Custom2',
    ...
    _custom3: $makeSchema(v.openapi({
      rest: {
        render: cel('getValue("name")!="kevin"?"text":"password"'),
        label: 'Custom3',
      },
    }), v.default('custom'), v.optional(), v.min(6), z.string()),
    _custom4: $makeSchema(v.openapi({
      rest: {
        // render: 'text',
        label: 'Custom4',
    ...
    _customCopy: $makeSchema(v.openapi({
      rest: {
        form: {
          render: (
    ...
    }), v.optional(), v.min(6), z.string()),
    _customCopied: $makeSchema(v.openapi({
      rest: {
        visible: false,
      },
    }), v.optional(), z.boolean()),
  },
})
