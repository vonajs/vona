...
import { l as ref, d as watch, L as toRaw, J as readonly, q as onMounted, A as onUnmounted, o as defineComponent, M as h } from "./vue-CRNsYCTs.js";
...
class EventClient {
  ...
  debugLog(...args) {
    if (__privateGet(this, _debug)) {
      console.log(`🌴 [tanstack-devtools:${__privateGet(this, _pluginId)}-plugin]`, ...args);
    }
  }
  getGlobalTarget() {
  ...
  on(eventSuffix, cb, options) {
    ...
    if (withEventTarget) {
      ...
      __privateGet(this, _internalEventTarget).addEventListener(eventName, (e) => {
        cb(e.detail);
      });
    }
    if (!__privateGet(this, _enabled)) {
    ...
    return () => {
      if (withEventTarget) {
        __privateGet(this, _internalEventTarget)?.removeEventListener(eventName, handler);
      }
...
export {
  useStore as a,
  useField as b,
  determineFormLevelErrorSourceAndValue as d,
  getBy as g,
  isGlobalFormValidationError as i,
  revalidateLogic as r,
  useForm as u
};
