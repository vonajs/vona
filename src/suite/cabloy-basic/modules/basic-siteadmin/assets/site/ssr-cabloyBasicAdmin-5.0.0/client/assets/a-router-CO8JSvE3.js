...
import { y as shallowReactive } from "./vue-BuTKVo3e.js";
import { d as defineComponent, g as inject, i as KeepAlive, l as createVNode, p as h } from "./vue-DeT-l8pH.js";
import { t as Transition } from "./vue-CsFxPVDb.js";
import { n as init_vue_runtime_esm_bundler } from "./vue-C_EuNVEw.js";
import { A as combineParamsAndQuery, c as init_dist, j as combineQueries, l as parseInfo, u as parseName, z as init_dist$1 } from "./zova-C8-MPvXl.js";
...
import { B as deepExtend, K as BeanSimple, M as BeanBase, S as Virtual, X as cast, Y as useComputed, b as BeanControllerBase, h as BeanScopeBase, k as BeanInfo, l as prepareComponentOptions, u as useController, v as BeanControllerPageBase, w as Use } from "./zova-BXlOOlVL.js";
import { t as init_src$1 } from "./zova-BJ0Q7wHc.js";
import { h as Controller, m as Bean, o as Scope, t as init_src$2, v as Service, x as Sys } from "./a-bean-BQjv0q8B.js";
import { i as Model, l as BeanModelBase, t as init_src$3 } from "./a-model-B9Gmxi-X.js";
import { a as createWebHistory, i as createWebHashHistory, n as RouterView, o as init_vue_router, r as createRouter, s as routerViewLocationKey } from "./vue-router-DF8M1khH.js";
	...
	MonkeySys = class extends BeanSimple {
		...
		sysApplicationInitialize(app) {
			...
			app.$gotoPage = (pagePath, options) => {
				...
				if (pagePath.startsWith("http://") || pagePath.startsWith("https://")) window.location[(options === null || options === void 0 ? void 0 : options.replace) ? "replace" : "assign"](pagePath);
