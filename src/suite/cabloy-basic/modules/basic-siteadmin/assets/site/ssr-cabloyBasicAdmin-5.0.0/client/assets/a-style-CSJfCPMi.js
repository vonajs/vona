...
import { C as UseScope, I as beanFullNameFromOnionName, K as useComputed, O as createBeanDecorator, U as BeanSimple, h as BeanScopeBase, j as BeanBase, k as BeanInfo, q as cast, z as deepExtend } from "./zova-DlmeBQBK.js";
import { t as init_src$1 } from "./zova-B7GgTsx0.js";
import { m as Bean, o as Scope, t as init_src$2 } from "./a-bean-BnjLZzu4.js";
import { a as style, i as init_lib_es2015, n as cssRaw, r as cssRule, t as createTypeStyle } from "./typestyle-DvkYjGD4.js";
import { l as BeanModelBase, t as init_src$3 } from "./a-model-Aj0LQ34C.js";
	...
	BeanTheme = (_dec$1 = Bean(), _dec2$1 = BeanInfo({ module: "a-style" }), _dec3 = UseScope("a-ssr"), _dec4 = Reflect.metadata("design:type", typeof ScopeModuleASsr === "undefined" ? Object : ScopeModuleASsr), _dec$1(_class$1 = _dec2$1(_class$1 = (_class2 = class BeanTheme extends BeanModelBase {
		...
		_applyThemeWrapper() {
			...
			return _asyncToGenerator(function* () {
				...
				if (_this2.sys.util.ignoreCookieOnServer()) {
					_this2.toggleDark();
					yield _this2._applyTheme();
				}
			})();
