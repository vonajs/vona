...
import { J as init_dist } from "./zova-DqTMfDEW.js";
import { m as init_asyncToGenerator, p as _asyncToGenerator } from "./fecha-DgbeIgox.js";
import { h as BeanScopeBase, k as BeanInfo, q as cast, r as $customKey, t as init_src$1 } from "./zova-DlmeBQBK.js";
import { t as init_src$2 } from "./zova-B7GgTsx0.js";
import { o as Scope, t as init_src$3 } from "./a-bean-BnjLZzu4.js";
import { n as Interceptor, r as SymbolInterceptorBodyResponseFlag, s as BeanInterceptorBase, t as init_src$4 } from "./a-fetch-C9UwTm9Y.js";
	...
	InterceptorJwt = (_dec$3 = Interceptor({ dependencies: "a-interceptor:headers" }), _dec2$3 = BeanInfo({ module: "a-interceptor" }), _dec$3(_class$3 = _dec2$3(_class$3 = class InterceptorJwt extends BeanInterceptorBase {
		...
		prepareAccessToken(config, authToken) {
			...
			return _asyncToGenerator(function* () {
				...
				if (_this3.sys.util.ignoreCookieOnServer()) return;
