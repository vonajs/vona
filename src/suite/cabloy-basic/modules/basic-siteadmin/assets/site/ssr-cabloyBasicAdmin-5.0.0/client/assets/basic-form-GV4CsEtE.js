...
import { d as defineComponent, l as createVNode, r as Fragment, v as mergeProps } from "./vue-Cbj8Orto.js";
...
import { K as useComputed, b as BeanControllerBase, d as ClientOnly, h as BeanScopeBase, k as BeanInfo, l as prepareComponentOptions, m as createZovaComponentAsync, s as useApp, u as useController, w as Use } from "./zova-DlmeBQBK.js";
import { t as init_src$1 } from "./zova-B7GgTsx0.js";
import { h as Controller, o as Scope, t as init_src$2 } from "./a-bean-BnjLZzu4.js";
import { r as invokeProp, t as init_src$3 } from "./zova-59AmBDzk.js";
import { i as init_lib_es2015, o as classes } from "./typestyle-DvkYjGD4.js";
import { a as Behavior, d as BeanBehaviorBase, t as init_src$4 } from "./a-behavior-DxWXg3Nz.js";
...
var init_behavior_formFieldLayout = __esmMin((() => {
	...
	BehaviorFormFieldLayout = (_dec$1 = Behavior(), _dec2$1 = BeanInfo({ module: "basic-form" }), _dec3 = Use({ injectionScope: "host" }), _dec4 = Reflect.metadata("design:type", typeof ControllerFormField === "undefined" ? Object : ControllerFormField), _dec$1(_class$1 = _dec2$1(_class$1 = (_class2 = class BehaviorFormFieldLayout extends BeanBehaviorBase {
		...
		_renderInline(renderContext, vnode, field, error) {
			...
			return createVNode("label", { "class": classes("input", renderContext.propsBucket.classContainer, bordered && "input-bordered", !field.state.meta.isValid && "input-error") }, [
				label,
				vnode,
		...
		_renderBlock(renderContext, vnode, field, error) {
			const label = renderContext.propsBucket.label;
			return createVNode("fieldset", { "class": classes("fieldset", renderContext.propsBucket.classContainer) }, [
