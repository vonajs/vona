...
//#endregion
//#region src/module/a-b/rest/component/card3.ts
function ZZBCard3(_props) {
	return "a-b:card3";
}

//#endregion
//#region src/module/a-b/rest/component/card.ts
function ZZBCard(_props) {
	return "a-b:card";
}

//#endregion
//#region src/module/a-b/rest/component/formFieldTest3.ts
function FFBTest3(_props) {
	return "a-b:formFieldTest3";
}

//#endregion
//#region src/module/a-b/rest/component/formFieldTest.ts
function FFBTest(_props) {
	return "a-b:formFieldTest";
}
...
//#endregion
//#region src/suite/a-demo/modules/demo-basic/rest/component/formFieldTest.ts
function FFDemoBasicTest(_props) {
	return "demo-basic:formFieldTest";
}

//#endregion
//#region src/suite/a-demo/modules/demo-basic/rest/component/tableCellTest.ts
function ZZDemoBasicTableCellTest(_props) {
	return "demo-basic:tableCellTest";
}

//#endregion
//#region src/suite/a-demo/modules/demo-basic/rest/component/actionView.ts
function ZZDemoBasicActionView(_props) {
	return "demo-basic:actionView";
}

//#endregion
//#region src/suite/a-demo/modules/demo-basic/rest/tableCell/test.ts
function TTDemoBasicTest(_props) {
...
//#endregion
//#region src/suite/a-home/modules/home-layout/rest/component/essentialLink.ts
function ZZHomeLayoutEssentialLink(_props) {
