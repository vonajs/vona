...
export class LocalAtom extends BeanBase {
  ...
  async default({ atomClass, roleIdOwner, item, options, user }) {
  ...
  async write({ key, atomClass, roleIdOwner, item, options, user }) {
  ...
  async clone({ key, atomClass, roleIdOwner, options, user }) {
  ...
  async _handleActionParams({ atomClass, action, options, fn }) {
    // action base
  ...
  async _handleActionParams_transaction({ options, params, fn }) {
    let res;
    // default is true
