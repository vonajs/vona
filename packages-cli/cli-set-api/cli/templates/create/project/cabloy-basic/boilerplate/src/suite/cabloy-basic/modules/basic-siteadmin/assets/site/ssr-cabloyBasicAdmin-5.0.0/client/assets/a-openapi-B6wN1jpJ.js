...
import { S as toRaw, _ as ref, y as shallowReactive } from "./vue-BuTKVo3e.js";
import { k as watch } from "./vue-DeT-l8pH.js";
import { n as init_vue_runtime_esm_bundler } from "./vue-C_EuNVEw.js";
import { H as isNil, P as evaluateSimple, i as init_esm, r as esm_default, z as init_dist } from "./zova-C8-MPvXl.js";
import { m as init_asyncToGenerator, p as _asyncToGenerator } from "./fecha-5qJk_cbF.js";
import { B as deepExtend, K as BeanSimple, M as BeanBase, T as usePrepareArg, X as cast, h as BeanScopeBase, k as BeanInfo, w as Use } from "./zova-BXlOOlVL.js";
import { t as external_exports } from "./zod-DXuNtoi4.js";
import { t as init_zod } from "./zod-Xas5f9JK.js";
import { t as init_src$1 } from "./zova-BJ0Q7wHc.js";
import { o as Scope, t as init_src$2, x as Sys } from "./a-bean-BQjv0q8B.js";
import { i as Model, l as BeanModelBase, t as init_src$3 } from "./a-model-B9Gmxi-X.js";
import { t as init_src$4 } from "./zova-CWLB1h7H.js";
import { n as init_oas30, t as init_oas31 } from "./openapi3-DISI5x_5.js";
		...
		createApiSchemas(api, apiMethod, apiOptions) {
			...
			return {
				...
				get requestBody() {
					...
					const schemaName = (_cast = cast(getSchemaOfRequestBody((_sdk$data3 = sdk.data) === null || _sdk$data3 === void 0 ? void 0 : _sdk$data3.operationObject))) === null || _cast === void 0 ? void 0 : _cast.$ref;
					if (!schemaName) return;
					return self.getSchema(schemaName).data;
				},
				get responseBody() {
					var _sdk$data4, _cast2, _schemaBody$propertie;
					const schemaBody = getSchemaOfResponseBody((_sdk$data4 = sdk.data) === null || _sdk$data4 === void 0 ? void 0 : _sdk$data4.operationObject);
					const schemaName = (_cast2 = cast(schemaBody === null || schemaBody === void 0 || (_schemaBody$propertie = schemaBody.properties) === null || _schemaBody$propertie === void 0 ? void 0 : _schemaBody$propertie.data)) === null || _cast2 === void 0 ? void 0 : _cast2.$ref;
					if (!schemaName) return;
					return self.getSchema(schemaName).data;
				},
				get paged() {
