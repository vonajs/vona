...
import { d as defineComponent, l as createVNode, v as mergeProps } from "./vue-DeT-l8pH.js";
...
import { M as BeanBase, Y as useComputed, _ as BeanRenderBase, b as BeanControllerBase, h as BeanScopeBase, k as BeanInfo, l as prepareComponentOptions, m as createZovaComponentAsync, s as useApp, u as useController, w as Use } from "./zova-BXlOOlVL.js";
...
import { n as init_lib, t as FlexRender } from "./tanstack-table-DfnL74Rh.js";
...
var init_tableCell_actionOperationsRow = __esmMin((() => {
	...
	TableCellActionOperationsRow = (_dec$2 = TableCell(), _dec2$2 = BeanInfo({ module: "basic-table" }), _dec$2(_class$2 = _dec2$2(_class$2 = class TableCellActionOperationsRow extends BeanBase {
		render(_options, renderContext, _next) {
			...
			}, [createVNode(ZIcon, { "name": "::draft" }, null)]), permissionDelete && createVNode("button", {
			...
			}, [createVNode(ZIcon, { "name": "::delete" }, null)])]);
		}
	}) || _class$2) || _class$2);
}));
//#endregion
