...
1. `Memory Cache`: Implemented based on [lru-cache](https://github.com/isaacs/node-lru-cache)
2. `Redis Cache`: Implemented based on [Redis](../redis/introduction.md)
3. `Summer Cache (Two-Layer Cache)`: Implemented using Memory Cache and Redis Cache
