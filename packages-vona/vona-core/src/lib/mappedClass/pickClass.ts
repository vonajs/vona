...
export function PickClass<T, KEYS extends Array<keyof T>>(classRef: Constructable<T>, keys: KEYS): Constructable<Pick<T, KEYS[number]>>;
export function PickClass<T, KEYS extends Array<keyof T> | undefined = undefined>(classRef: Constructable<T>, keys?: KEYS): TypePickClass<T, KEYS> {
