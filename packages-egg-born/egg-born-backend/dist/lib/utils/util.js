...
module.exports = app => {
    return {
            ...
            return function (context, next) {
                ...
                function dispatch(i) {
                    ...
                    if (chain) {
                        ...
                        fn = obj.fn;
                        if (!fn)
                            return new Error('fn is not defined');
                    }
                    if (i === chains.length)
                        fn = next;
                    if (!fn)
            ...
            return function (context, next) {
                ...
                function dispatch(i) {
                    ...
                    if (chain) {
                        ...
                        fn = obj.fn;
                        if (!fn)
                            return Promise.reject(new Error('fn is not defined'));
                    }
                    if (i === chains.length)
                        fn = next;
                    if (!fn)
        ...
        async executeBean({ locale, subdomain, beanModule, beanFullName, context, fn, transaction, ctxCaller, ctxParent, instance, }) {
            var _a, _b, _c, _d;
            // ctxModule
            const ctxModule = beanModule || ((_b = (_a = ctxCaller === null || ctxCaller === void 0 ? void 0 : ctxCaller.module) === null || _a === void 0 ? void 0 : _a.info) === null || _b === void 0 ? void 0 : _b.relativeName) || ((_d = (_c = ctxParent === null || ctxParent === void 0 ? void 0 : ctxParent.module) === null || _c === void 0 ? void 0 : _c.info) === null || _d === void 0 ? void 0 : _d.relativeName);
            // ctx
